...
public class ExemploUso {
	...
	public static void main(String[] args) {
		...
		String mask="##/##/####";
		String entrada="12092017";
		String caracteresValidos="0123456789";
		
		System.out.println("Entrada: "+entrada);
		InputFormatter teste = new InputFormatter();
		teste.setMask(mask);
		teste.setCaracteresValidos(caracteresValidos);
		teste.setInputText(entrada);
		teste.formatStringMask();
		System.out.println("Depois: "+ teste.getOutputText());
	}
